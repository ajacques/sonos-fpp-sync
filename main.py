...
def encode_sync_packet(sequence_name: str, fseq_file: SeqDetails, seconds_elapsed, total_seconds):
    return struct.pack(
...
def process_sonos_packet(event: soco.events_base.Event):
    ...
    #encode_sync_packet('romeo.fseq', fseq_table[0], elapsed, duration)
    #print("Packet")
    #pprint(event)
